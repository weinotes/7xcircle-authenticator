/**
 * 7X Circle Authenticator — PIN entry screen shown while the app lock is engaged
 *
...
export function LockScreen({ onUnlocked }: LockScreenProps) {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center bg-[#1a1a2e] px-8 pt-[max(2rem,var(--app-safe-top))] pb-[max(2rem,var(--app-safe-bottom))]">
