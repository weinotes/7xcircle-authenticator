...
1. The contribution was created in whole or in part by me and I have the right
   to submit it under the open source license indicated in the project; or
...
Contributions must be signed off with `git commit -s`, which adds a
`Signed-off-by: Your Name <you@example.com>` trailer to the commit message.
